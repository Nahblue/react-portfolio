  ...
  return(
    <nav className="flex max-w-6xl mx-auto justify-between py-4 px-10 bg-transparent lg:px-4">
      ...
      <ul className="flex gap-8 font-medium text-slate-500 dark:text-slate-200">
        ...
        <li><a href="https://drive.google.com/file/d/1ZzOAHM0qvdsr4lkFa1wMxl2EnBQmQ-Z-/view?usp=sharing" target="_blank" className="flex justify-center items-center hover:text-slate-800 dark:hover:text-slate-300">CV <GoArrowUpRight /></a></li>
      </ul>
    </nav>
  )
}
